...
import { GAddProductIcon, GAdministrationIcon, GBooksIcon, GCashierIcon, GCashierThreeIcon, GContractIcon, GCustomersIcon, GDispatchIcon, GExpensesIcon, GInventoryIcon, GKardexIcon, GLogoutIcon, GOrdersIcon, GPendingSalesIcon, GPolicyIcon, GProductionIcon, GPurchasesIcon, GReportsIcon, GRequisitionIcon, GSalesAgentIcon, GShippingIcon, GTicketIcon, GTrackIcon, GTruckIcon } from '../utils/IconImageProvider';
